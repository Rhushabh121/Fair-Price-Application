...
//
//            if (mainIntent != null) {
//                int tempId = mainIntent.getIntExtra("PostId", 1);
...
//                if (title != null) {
//                    accessPosts.addPost(new Post(tempId, title, description, Integer.valueOf(price)));
//                }
//            }
//        }
//        else
//            System.out.println("error in accessing the posts data");
    }
