...
public class LoginTest {
    ...
    public void loginTest() {
        ...
        ViewInteraction appCompatButton4 = onView(
                allOf(withId(R.id.button8), withText("Back"),
                        childAtPosition(
        ...
        ViewInteraction appCompatButton5 = onView(
                allOf(withId(R.id.button9), withText("Back"),
                        childAtPosition(
                                allOf(withId(R.id.constraintLayout3),
                                        childAtPosition(
                                                withClassName(is("androidx.constraintlayout.widget.ConstraintLayout")),
        ...
        ViewInteraction appCompatButton6 = onView(
                allOf(withId(R.id.button4), withText("Login"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        0),
        ...
        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.editTextTextPersonName),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText6.perform(replaceText("xyz"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText8 = onView(
                allOf(withId(R.id.editTextTextPersonName3), withText("xyz"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatButton7 = onView(
                allOf(withId(R.id.button5), withText("Sign in"),
                        childAtPosition(
