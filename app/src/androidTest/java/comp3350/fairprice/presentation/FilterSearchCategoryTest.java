...
public class FilterSearchCategoryTest {
    ...
    @Test
    public void filterSearchCategoryTest() {
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.NewPostTitle),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("Table"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.NewPostDescription),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("nice table"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText7 = onView(
                allOf(withId(R.id.usernameIdentifier),
                        childAtPosition(
                                ...
                                6),
                        isDisplayed()));
        appCompatEditText7.perform(replaceText("xyz"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatButton7 = onView(
                allOf(withId(R.id.button2), withText("Categories"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.RelativeLayout")),
                                        1),
